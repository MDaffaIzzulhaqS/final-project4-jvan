...
import com.finalprojectkelompok6.finalproject4_backup.Model.User;
...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void createAccountRealtimeDatabase(String name, String email, String password, String phoneNumber) {
        ...
        DatabaseReference databaseReference = database.getReferenceFromUrl("https://busreservationapp-f7bf0-default-rtdb.firebaseio.com");
